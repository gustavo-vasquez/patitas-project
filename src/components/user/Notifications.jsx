        ...
        <div className="notifications-wrapper">
            ...
            <div className="card notification text-center">
                <div className="card-body">
                    <h5 className="card-title">El <Link to="/shelter/1">Refugio #1</Link> ha respondido tu solicitud de adopción</h5>
                    ...
                    <p><b>10/11/2022 a las 12:00 hs.</b></p>
            ...
            <div className="card notification text-center">
                <div className="card-body">
                    ...
                    <p className="card-text pt-2">Has confirmado tu asistencia para visitar el <Link to="/shelter/1">Refugio #1</Link> en la siguiente fecha:</p>
                    <p><b>10/11/2022 a las 12:00 hs.</b></p>
                </div>
