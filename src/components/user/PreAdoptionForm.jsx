...
function PreAdoptionForm() {
    ...
    return (
        <div id="adoption_form_wrapper">
            <h5>Para poder postularse e iniciar el proceso de adopción de un animal, es necesario que completes este formulario para brindarle información a los refugios sobre tu persona y te tengan en consideración.</h5>
